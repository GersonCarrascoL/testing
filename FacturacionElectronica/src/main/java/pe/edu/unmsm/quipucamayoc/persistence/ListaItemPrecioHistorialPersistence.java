...
public interface ListaItemPrecioHistorialPersistence {
	...
	@Results(value = {
	@Result(javaType = ListaItemPrecioHistorialModel.class),
	...
	@Result(property = "unidadMedidaDesc",column = "UNIMEDDES"),
	@Result(property = "numResolucion",column = "numResolucion"),
	@Result(property = "nameTipoResolucion",column = "nameTipoResolucion")
	})
	public List<ListaItemPrecioHistorialModel> getListaItemHistorialItem(@Param("ud_id") Integer udId, @Param("cod_item") String codItem);
