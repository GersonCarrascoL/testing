...
(function (factory) {
    ...
    tModalMain = '<div id="' + MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' +
        MODAL_ID + 'Label"></div>';
    tModal = '<div class="modal-dialog modal-lg">\n' +
    ...
    FileInput.prototype = {
        ...
        _getCloseButton: function (type) {
            ...
            return '<button type="button" onclick="myFunction()" class="' + css + ' btn-' + type + '"' + params + '>' + label + '</button>';
        },
        _getModalContent: function () {
            ...
            return self._getLayoutTemplate('modal')
                ...
                .replace(/\{close}/g, self._getCloseButton('close'));
        },
